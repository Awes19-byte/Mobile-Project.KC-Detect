package com.example.myapplication;//HomeActivity.java
...
import com.example.myapplication.ml.Metadata;
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            tflite=new Interpreter(loadmodelfile(HomeActivity.this));
        }catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private MappedByteBuffer loadmodelfile(Activity activity) throws IOException {
        AssetFileDescriptor fileDescriptor=activity.getAssets().openFd("metadata.tflite");
...
//To set components of x axis
    ...
    private void showresult(){
        ...
        try{
            labels = FileUtil.loadLabels(HomeActivity.this,"labels.txt");
        }catch (Exception e){
            e.printStackTrace();
        }
